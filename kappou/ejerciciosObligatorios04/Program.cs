...
namespace ejerciciosObligatorios4
{
    ...
    class Ejecutable
    {
        static void Main(string[] args)
        {
            ...
            electrodomesticos[8] = new Television(23, 32);
            electrodomesticos[9] = new Lavadora(98, 21);
            ...
            Console.WriteLine("Hay " + tipos.Count() + " tipos de clases");
